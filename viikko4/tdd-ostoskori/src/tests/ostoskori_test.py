...
class TestOstoskori(unittest.TestCase):
   ...
   # step 2
    ...
    # step 12
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_ostokset_oikein(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    # step 13
    def test_kahden_saman_tuotteen_lisaamisen_ja_yhden_poiston_jalkeen_ostokset_oikein(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    # step 14
    def test_tuotteen_lisaamisen_ja_poiston_jalkeen_ostokskori_tyhja(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
